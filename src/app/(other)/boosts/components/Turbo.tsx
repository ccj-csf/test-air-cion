  ...
  return (
    <main>
      ...
      >
        ...
        <Image src="/icons/fire.svg" alt="fire" width={36} height={36} />
      </section>
      <BaseSlideUpModal ref={modalRef}>
        <main className="mt-4 flex flex-col items-center px-8">
          <h2 className="font-700 text-24">Turbo</h2>
          <Image src="/icons/fire.svg" alt="fire1" width={78} height={90} className="mb-2 mt-6" />
          <p className="text-14">Recharge your Turbo to maximum</p>
